...
public unsafe class World
{
        ...
        ref ecs_system_desc_t systemDesc, CallbackIterator callback, ecs_entity_t phase, string? name)
    {
        ...
        FnPtr_Ecs_iter_tPtr_Void.@delegate pointerCallbackMove = SystemCallback;
        systemDesc.callback.Data.Pointer = Marshal.GetFunctionPointerForDelegate(pointerCallbackMove) ;
